var __dsPreview = (() => {
  ...
  // .design-sync/previews/Flashcard.tsx
  var Flashcard_exports = {};
  __export(Flashcard_exports, {
    Answer: () => Answer,
    Question: () => Question
  });
  init_define_import_meta_env();
  ...
  var Question = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.Flashcard,
    {
      topic: "Rioja",
      side: "question",
  ...
  var Answer = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.Flashcard,
    {
      topic: "Rioja",
      side: "answer",
  ...
  return __toCommonJS(Flashcard_exports);
})();
